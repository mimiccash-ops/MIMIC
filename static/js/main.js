...
const translations = {
    ...
    ua: {
        ...
        'dash.nodes': 'Вузли',
        'dash.trades': 'Угоди',
        'dash.masterPositions': 'Позиції майстра',
        ...
        'dash.selectExchange': 'Оберіть біржу...',
        'dash.accountLabel': 'Назва акаунту (опціонально)',
        'dash.apiKey': 'API Ключ',
        'dash.apiSecret': 'API Секрет',
        'dash.passphrase': 'Парольна фраза',
        'dash.submitRequest': 'Погнали',
        ...
        'auth.signInToMimic': 'Увійди до свого акаунту MIMIC',
        'auth.systemReady': 'СИСТЕМА ГОТОВА',
        'auth.usernamePhone': 'Юзернейм / Телефон',
        ...
        'auth.startMimicking': 'Почни копіювати найкращих трейдерів',
        ...
        // Home page
        'home.automatedCopyTrading': 'Автоматична платформа копі-трейдингу',
        'home.tradeLike': 'Торгуй як',
        'home.tradeLikeTheBest': 'Найкращі',
        'home.subtitle': 'Підключи API біржі та автоматично копіюй угоди професійних трейдерів. Без ручної роботи — повністю автоматизований профіт.',
        'home.startTradingNow': 'Запустити трейдинг',
        'home.signIn': 'Увійти',
        'home.automatedTrading': 'Автотрейдинг 24/7',
        'home.signalLatency': 'Швидкість сигналу',
        'home.transparency': 'Прозорість',
        'home.coreFeatures': 'Фішки платформи',
        'home.whyChooseMimic': 'Чому MIMIC?',
        'home.whyChooseSubtitle': 'Професійний копі-трейдинг з крутою технологією та максимальною безпекою.',
        'home.lightningFast': 'Блискавична швидкість',
        'home.lightningFastDesc': 'Виконання угод за долі секунди — ти ніколи не пропустиш можливість. Система копіює трейди в реальному часі з мінімальною затримкою.',
        'home.maximumSecurity': 'Максимальна безпека',
        'home.maximumSecurityDesc': 'Твої API ключі зашифровані та безпечно зберігаються. Ми ніколи не маємо доступу до виведення — твої гроші завжди під твоїм контролем.',
        'home.realTimeAnalytics': 'Аналітика в реальному часі',
        'home.realTimeAnalyticsDesc': 'Відстежуй продуктивність свого портфеля з детальною статистикою, історією угод та графіками зростання — все в одному дашборді.',
        'home.customizableRisk': 'Налаштування ризику',
        'home.customizableRiskDesc': 'Встанови власні параметри ризику, обмеження плеча та розміри позицій. Торгуй впевнено з налаштуваннями під твою стратегію.',
        'home.instantNotifications': 'Миттєві сповіщення',
        'home.instantNotificationsDesc': 'Отримуй Telegram-сповіщення для кожної угоди, оновлення позиції та важливих подій. Будь в курсі 24/7.',
        'home.directSupport': 'Пряма підтримка',
        'home.directSupportDesc': 'Вбудована система повідомлень для прямого зв\'язку з адмінами. Отримай допомогу, коли потрібно, без сторонніх тікетів.',
        'home.gettingStarted': 'Як почати',
        'home.howItWorks': 'Як це працює',
        'home.howItWorksSubtitle': 'Почни копі-трейдинг у три прості кроки. Ніяких складних налаштувань.',
        'home.createAccount': 'Створи свій акаунт',
        'home.createAccountDesc': 'Зареєструйся з номером телефону та підключи біржу через API ключі. Підтримуємо топові біржі: Binance, Bybit, OKX та інші.',
        'home.waitApproval': 'Дочекайся схвалення',
        'home.waitApprovalDesc': 'Наша команда перевіряє твої API ключі та налаштування акаунту. Після схвалення акаунт буде активовано та готовий до автотрейдингу.',
        'home.startMimicking': 'Почни копіювати',
        'home.startMimickingDesc': 'Після активації твій акаунт автоматично копіює позиції майстра-трейдера. Відпочивай і спостерігай, як твій портфель росте з професійними трейдами.',
        'home.supportedExchanges': 'Підтримувані біржі',
        'home.tradeOnTopExchanges': 'Торгуй на топових біржах',
        'home.tradeOnTopExchangesSubtitle': 'Підключи улюблену біржу та запускай копі-трейдинг миттєво.',
        'home.available': 'Доступно',
        'home.readyToStart': 'Готовий почати?',
        'home.readyToStartSubtitle': 'Приєднуйся зараз і дозволь професійним трейдерам працювати на тебе. Твоя подорож до автоматичного профіту починається тут.',
        'home.createFreeAccount': 'Створити акаунт безкоштовно',
        
        // Additional dashboard
        'dash.target': 'Ціль',
        'dash.statistics': 'Статистика',
        'dash.messages': 'Повідомлення',
        'dash.clickChange': 'Натисни "Змінити", щоб вибрати новий аватар',
        'dash.trades': 'угод',
        'dash.users': 'юзерів',
        'dash.live': 'Live',
        ...
        'footer.features': 'Фішки',
        'footer.copyTrading': 'Копі-трейдинг',
        'footer.realTimeMirroring': 'Копіювання в реальному часі',
        'footer.riskManagement': 'Менеджмент ризиків',
        'footer.telegramAlerts': 'Telegram сповіщення',
        'footer.desc': 'Автоматична платформа копі-трейдингу нового покоління. Копіюй професійних трейдерів у реальному часі.',
        'footer.trading': 'Трейдинг',
        'footer.latency': 'Швидкість',
        'footer.automated': 'Автоматично',
        'footer.rights': 'Всі права захищено.',
        'footer.warning': 'Трейдинг пов\'язаний з ризиком. Не є фінансовою порадою.',
        'footer.faq': 'FAQ',
        ...
        'leaderboard.subtitle': 'Відстежуй продуктивність наших топ-трейдерів у режимі реального часу. Дивись хто лідирує.',
        'leaderboard.totalUsers': 'Всього юзерів',
        'leaderboard.totalVolume': 'Загальний обсяг',
        'leaderboard.totalProfit': 'Загальний профіт',
        'leaderboard.totalTrades': 'Всього угод',
        'leaderboard.topCopiers': 'Топ трейдерів',
        'leaderboard.today': 'Сьогодні',
        'leaderboard.trader': 'Трейдер',
        'leaderboard.trades': 'Угоди',
        'leaderboard.masterTrader': 'Майстер-трейдер',
        'leaderboard.30DayPerformance': 'Результати за 30 днів',
        'leaderboard.totalPnl': 'Загальний PnL',
        'leaderboard.winRate': 'Вінрейт',
        'leaderboard.readyToJoin': 'Готовий до топу?',
        'leaderboard.readyToJoinSubtitle': 'Запускай копі-трейдинг сьогодні та автоматично копіюй угоди найкращих трейдерів. Досвід не потрібен.',
        'leaderboard.copyNow': 'Копіювати зараз — Безкоштовно',
        'leaderboard.loadingLeaderboard': 'Завантаження рейтингу...',
        'leaderboard.noActivity': 'Ще немає трейдингу. Будь першим!',
        'leaderboard.failedToLoad': 'Щось пішло не так. Спробуй ще раз.',
        'leaderboard.noBalanceHistory': 'Історія балансу недоступна',
        
        // Tournament page
        'tournament.title': 'Щотижневий турнір',
        'tournament.subtitle': 'Змагайся з трейдерами з усього світу. Заходь за $10, торгуй на максимум і забирай частину призового фонду. ТОП-3 за ROI забирають все!',
        'tournament.endsIn': 'Турнір закінчується через',
        'tournament.startsIn': 'Турнір стартує через',
        ...
        'tournament.live': 'LIVE - Трейдинг активний',
        ...
        'tournament.entryFee': 'Вхідний внесок',
        ...
        'tournament.loginToJoin': 'Увійди для участі',
        'tournament.joinFor': 'Приєднатися за',
        'tournament.registrationClosed': 'Реєстрацію закрито',
        'tournament.joining': 'Заходимо...',
        'tournament.youreParticipating': 'Ти в грі!',
        'tournament.yourRank': 'Твій рейтинг',
        'tournament.yourRoi': 'Твій ROI',
        'tournament.yourPnl': 'Твій PnL',
        'tournament.liveLeaderboard': 'Live рейтинг',
        'tournament.realTime': 'Реальний час',
        'tournament.rank': 'Місце',
        'tournament.roi': 'ROI',
        'tournament.pnl': 'PnL',
        'tournament.noParticipants': 'Ще немає учасників. Будь першим!',
        'tournament.noActiveTournament': 'Немає активного турніру',
        'tournament.noActiveTournamentDesc': 'Наступний щотижневий турнір готується. Зайди пізніше або зареєструйся, щоб отримати сповіщення про старт!',
        'tournament.createAccount': 'Створити акаунт',
        ...
        // Index/Home extras
        'home.viewLeaderboard': 'Дивись рейтинг',
        'home.safetyPool': 'Страховий фонд',
        'home.mirrorTraders247': 'Копіюй професійних трейдерів 24/7',
